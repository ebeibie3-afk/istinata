...
const FLOW_CHANNELS: CorruptionChannel[] = [
  {
    ...
    title: 'ПЪЛНА ВЕРТИКАЛНА ПИРАМИДА: От Върха до Поморие & Уличните Дилъри',
    ...
    primaryBeneficiaries: [
      ...
      'Квартални Надзорници & Поморийски Хъб: Добри Добрев (Поморие), Иво Йовов (Поморие), Венцислав Христов (Лавацата), Радослав Николов (Рачо), Иван Пъндев, Радослав Иванов (Темерута), Росен Драгнев (Капитана), Николай Тошев (Чирпанския), Иван Цонков (Джиджито)',
      'Складови Депа, Куриери & Telegram: Pigeon Express (Александър Апостолов, Елена Петлешкова), Депа Поморие, Меден Рудник, Люлин, Надежда, Столипиново',
      'Улични Дилъри & Изпълнители: Поморийски улични дилъри (Добри Добрев, Иво Йовов), нощни клубове Слънчев бряг/София, фитнес пласьори, училищни дропъри'
    ],
    bufferCompanies: [
    ...
    cashWithdrawalPoints: [
      ...
      'Каси на чейндж бюра, казина и лизингови къщи в Поморие, Слънчев бряг, София, Пловдив и Варна',
    ...
    legalAuditEvidence: 'Присъди по НОХД № 2145/2018 г. (СНС), НОХД № 451/2021 г. (СГС), бюлетини на DEA, ДАНС, ГДБОП и оперативни реализации в Поморие и Бургас.',
...
export default function FlowVisualizer() {
  ...
  // 🌟 ПЪЛНА МРЕЖА С ВКЛЮЧЕНИ ДОБРИ ДОБРЕВ, ИВО ЙОВОВ (ПОМОРИЕ) И ВСИЧКИ УЛИЧНИ ДИЛЪРИ
...
graph TD
    ...
    POLICE_TOP["👮 Шефове на ОДМВР-Бургас, ГДБОП & РУ-Поморие/Несебър<br/><b>Оперативен чадър и предупреждаване за акции</b>"]
    ...
    %% ==========================================
    %% НИВО 6: КВАРТАЛНИ ОТГОВОРНИЦИ, СКЛАДОВИ ДЕПА & ДИСПЕЧЕРИ
    %% ==========================================
    DOBRI_DOBREV["👤 Добри Добрев (Поморие)<br/><b>Поморийски надзорник & Разпределител на улицата</b>"]
    IVO_YOVOV["👤 Иво Йовов (Поморие)<br/><b>Складово депо Поморие & Логистика на зарежданията</b>"]
    ...
    %% ==========================================
    DEALERS_POMORIE["💊 Улични дилъри: Поморие (Мъртви тайници & Заведения)<br/><b>Пласмент на кокаин, пико и марихуана под контрола на Добри Добрев и Иво Йовов</b>"]
    DEALER_CLUBS_SB["💊 Клубни дилъри: Слънчев бряг, Несебър & Созопол<br/><b>Пласмент на кокаин и екстази в дискотеки, плажни барове и алеи</b>"]
    DEALER_SOFIA_NIGHT["💊 Клубни дилъри: Студентски град & Център<br/><b>Нощни клубове, пико и амфетамини</b>"]
    DROPPERS_TELEGRAM["🏃 Telegram Дропъри на Мъртви Тайници<br/><b>Залагане на дози по GPS координати в градинки и входове</b>"]
    ...
    MULES_EASYPAY["💳 Финансови Мулета (Revolut / EasyPay / P2P USDT)<br/><b>Теглене на уличния оборот и кешови преводи</b>"]
    ...
    %% Лейтенанти -> Поморийски хъб & Квартални Отговорници
    EYES -->|Силово командване Поморие| SHIROKOV
    SHIROKOV -->|Разпределение на уличната мрежа в Поморие| DOBRI_DOBREV
    SHIROKOV -->|Управление на складовото депо Поморие| IVO_YOVOV
    DOBRI_DOBREV -->|Логистична връзка и зареждане| IVO_YOVOV
    ...
    %% Отговорници & Поморийски хъб -> Улични Дилъри & Дропъри
    DOBRI_DOBREV -->|Директен контрол на уличните пласьори в Поморие| DEALERS_POMORIE
    IVO_YOVOV -->|Зареждане на депа, тайници и барове в Поморие| DEALERS_POMORIE
    LAVATSATA -->|Зареждане на алеи и дискотеки| DEALER_CLUBS_SB
    RACHO -->|Зареждане на плажни барове Несебър/Равда| DEALER_CLUBS_SB
    ...
    %% Обратен Финансов Поток: Улица -> Поморийски босове -> Лейтенанти -> Банки -> Дубай
    DEALERS_POMORIE -->|Предаване на дневния кеш в Поморие| DOBRI_DOBREV
    DEALERS_POMORIE -->|Отчитане на оборот от депото| IVO_YOVOV
    DOBRI_DOBREV -->|Поморийски дял| SHIROKOV
    IVO_YOVOV -->|Отчитане на складов оборот| SHIROKOV
    SHIROKOV -->|Предаване на поморийския дял| EYES

    DEALER_CLUBS_SB -->|Кеш от оборот Сл. бряг| LAVATSATA
    DEALER_SOFIA_NIGHT -->|Кеш от оборот София| KAPITANA
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              <div style={{ color: '#FFFFFF', fontWeight: 900, fontSize: '1.3rem', fontFamily: 'var(--font-serif)', textTransform: 'uppercase', letterSpacing: '0.04em' }}>
                VERITAS // ВЕРТИКАЛНА КАРТОТЕКА: ОТ ВЪРХА ДО ПОМОРИЕ (ДОБРИ ДОБРЕВ & ИВО ЙОВОВ) И УЛИЦАТА
              </div>
              <div style={{ color: '#94A3B8', fontSize: '0.82rem', fontFamily: 'var(--font-mono)', marginTop: '2px' }}>
                ПЪЛНА СТРУКТУРА: ВЛАСТ ➔ ПРОКУРАТУРА ➔ ШИРОКАТА ➔ ДОБРИ ДОБРЕВ & ИВО ЙОВОВ (ПОМОРИЕ) ➔ УЛИЧНИ ДИЛЪРИ ➔ ДУБАЙ
              </div>
            </div>
          </div>
